...
const TAILWIND_UTILITIES: Record<string, string> = {
  ...
  // 4 columns: 1 column on mobile, scales up on larger screens
  'grid-cols-4': 'grid-template-columns: repeat(1, minmax(0, 1fr));',
  // 5 columns: 1 column on mobile, scales up on larger screens
...
`);
  ...
  if (classes.has('grid-cols-4')) {
    cssRules.push(`
/* grid-cols-4: 1 column on mobile, 2 on tablet, 4 on desktop */
@media (min-width: 768px) {
  .grid-cols-4 {
    grid-template-columns: repeat(2, minmax(0, 1fr)) !important;
  }
...
`);
  ...
  if (classes.has('grid-cols-5')) {
    cssRules.push(`
/* grid-cols-5: 1 column on mobile, 2 on tablet, 5 on extra-large */
@media (min-width: 768px) {
  .grid-cols-5 {
    grid-template-columns: repeat(2, minmax(0, 1fr)) !important;
  }
